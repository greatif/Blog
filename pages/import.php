...
$formElements = [];
$n = [];
$n['label'] = '<label for="rex-form-importdbfile">' . rex_i18n::msg('blog_import_backup-file') . '</label>';
...
$formElements = [];
$n = [];
$n['field'] = '<button class="btn btn-send rex-form-aligned" type="submit" value="' . rex_i18n::msg('blog_import_backup-file_button') . '"><i class="rex-icon rex-icon-import"></i> ' . rex_i18n::msg('blog_import_backup-file_button') . '</button>';
$formElements[] = $n;
...
$fragment = new rex_fragment();
$fragment->setVar('title', rex_i18n::msg('blog_import'), false);
$fragment->setVar('body', $content, false);
$fragment->setVar('buttons', $buttons, false);
$content = $fragment->parse('core/page/section.php');

$content = '
<form action="' . rex_url::currentBackendPage() . '" enctype="multipart/form-data" method="post" data-confirm="' . rex_i18n::msg('blog_import_backup-file_proceed') . '">
