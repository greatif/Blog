...
$moduleInput = rex_file::get(rex_path::addon('gblog') . "module/blog-teaser_input.php");
$moduleOutput = rex_file::get(rex_path::addon('gblog') . "module/blog-teaser_output.php");
